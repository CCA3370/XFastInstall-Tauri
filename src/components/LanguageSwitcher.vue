<template>
  <button
    ...
    class="flex items-center justify-center w-16 px-3 py-2 text-sm bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm border border-white/20"
